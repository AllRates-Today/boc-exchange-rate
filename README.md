...
Official **Bank of Canada** (Canada) daily exchange rates in Node.js / TypeScript — 24 currencies against the CAD, with history back to 2017. Zero dependencies, works in Node 18+, Bun, Deno, and edge runtimes (uses global `fetch`).
...
Powered by [AllRatesToday](https://allratestoday.com/central-bank-rates-api/boc/). Get a free API key at [allratestoday.com/register](https://allratestoday.com/register) — no credit card required.
