# Bank of Canada Exchange Rate API — boc-exchange-rate
...
Also published under the org scope as [`@allratestoday/boc-exchange-rate`](https://www.npmjs.com/package/@allratestoday/boc-exchange-rate) — same code, same versions.
